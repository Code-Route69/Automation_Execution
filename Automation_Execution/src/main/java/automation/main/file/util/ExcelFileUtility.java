...
public class ExcelFileUtility {
	...
	public String getValue( int rownum, int colnum ) {
		...
		} else if ( cell.getCellType( ) != null && cell.getCellType( ) == CellType.FORMULA && cell.getCachedFormulaResultType( ) == CellType.STRING ) {
			return sheet.getRow( rownum ).getCell( colnum ).getStringCellValue( );
		} else if ( cell.getCellType( ) != null && cell.getCellType( ) == CellType.FORMULA && cell.getCachedFormulaResultType( ) == CellType.NUMERIC ) {
	...
	public void setCellData( int R, int C, String data ) {
